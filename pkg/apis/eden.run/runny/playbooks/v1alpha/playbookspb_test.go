...
func BenchmarkPlayBookProtoMarshal(b *testing.B) {
	popr := math_rand.New(math_rand.NewSource(616))
	total := 0
	pops := make([]*PlayBook, 10000)
	for i := 0; i < 10000; i++ {
		pops[i] = NewPopulatedPlayBook(popr, false)
	}
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
...
func BenchmarkPlayBookProtoUnmarshal(b *testing.B) {
	popr := math_rand.New(math_rand.NewSource(616))
	total := 0
	datas := make([][]byte, 10000)
	for i := 0; i < 10000; i++ {
		dAtA, err := github_com_gogo_protobuf_proto.Marshal(NewPopulatedPlayBook(popr, false))
		if err != nil {
			panic(err)
		}
		datas[i] = dAtA
...
func BenchmarkPlayBookListProtoMarshal(b *testing.B) {
	popr := math_rand.New(math_rand.NewSource(616))
	total := 0
	pops := make([]*PlayBookList, 10000)
	for i := 0; i < 10000; i++ {
		pops[i] = NewPopulatedPlayBookList(popr, false)
	}
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		dAtA, err := github_com_gogo_protobuf_proto.Marshal(pops[i%10000])
...
func BenchmarkPlayBookListProtoUnmarshal(b *testing.B) {
	popr := math_rand.New(math_rand.NewSource(616))
	total := 0
	datas := make([][]byte, 10000)
	for i := 0; i < 10000; i++ {
		dAtA, err := github_com_gogo_protobuf_proto.Marshal(NewPopulatedPlayBookList(popr, false))
		if err != nil {
			panic(err)
		}
		datas[i] = dAtA
...
func BenchmarkPlayBookSpecProtoMarshal(b *testing.B) {
	popr := math_rand.New(math_rand.NewSource(616))
	total := 0
	pops := make([]*PlayBookSpec, 10000)
	for i := 0; i < 10000; i++ {
		pops[i] = NewPopulatedPlayBookSpec(popr, false)
	}
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		dAtA, err := github_com_gogo_protobuf_proto.Marshal(pops[i%10000])
...
func BenchmarkPlayBookSpecProtoUnmarshal(b *testing.B) {
	popr := math_rand.New(math_rand.NewSource(616))
	total := 0
	datas := make([][]byte, 10000)
	for i := 0; i < 10000; i++ {
		dAtA, err := github_com_gogo_protobuf_proto.Marshal(NewPopulatedPlayBookSpec(popr, false))
		if err != nil {
			panic(err)
		}
		datas[i] = dAtA
...
func BenchmarkPlayBookSize(b *testing.B) {
	popr := math_rand.New(math_rand.NewSource(616))
	total := 0
	pops := make([]*PlayBook, 1000)
	for i := 0; i < 1000; i++ {
		pops[i] = NewPopulatedPlayBook(popr, false)
	}
	b.ResetTimer()
...
func BenchmarkPlayBookListSize(b *testing.B) {
	popr := math_rand.New(math_rand.NewSource(616))
	total := 0
	pops := make([]*PlayBookList, 1000)
	for i := 0; i < 1000; i++ {
		pops[i] = NewPopulatedPlayBookList(popr, false)
	}
	b.ResetTimer()
...
func BenchmarkPlayBookSpecSize(b *testing.B) {
	popr := math_rand.New(math_rand.NewSource(616))
	total := 0
	pops := make([]*PlayBookSpec, 1000)
	for i := 0; i < 1000; i++ {
		pops[i] = NewPopulatedPlayBookSpec(popr, false)
	}
	b.ResetTimer()
