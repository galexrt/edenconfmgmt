...
func (this *EventList) Validate() error {
...
func (this *EventSpec) Validate() error {
	return nil
}
...
func (this *ListResponse) Validate() error {
	if this.EventList != nil {
		if err := github_com_mwitkow_go_proto_validators.CallValidatorIfExists(this.EventList); err != nil {
			return github_com_mwitkow_go_proto_validators.FieldError("EventList", err)
		}
	}
	return nil
}
