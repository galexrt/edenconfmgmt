...
func BenchmarkCronJobProtoMarshal(b *testing.B) {
	popr := math_rand.New(math_rand.NewSource(616))
	total := 0
	pops := make([]*CronJob, 10000)
	for i := 0; i < 10000; i++ {
		pops[i] = NewPopulatedCronJob(popr, false)
	}
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
...
func BenchmarkCronJobProtoUnmarshal(b *testing.B) {
	popr := math_rand.New(math_rand.NewSource(616))
	total := 0
	datas := make([][]byte, 10000)
	for i := 0; i < 10000; i++ {
		dAtA, err := github_com_gogo_protobuf_proto.Marshal(NewPopulatedCronJob(popr, false))
		if err != nil {
			panic(err)
		}
		datas[i] = dAtA
...
func BenchmarkCronJobListProtoMarshal(b *testing.B) {
	popr := math_rand.New(math_rand.NewSource(616))
	total := 0
	pops := make([]*CronJobList, 10000)
	for i := 0; i < 10000; i++ {
		pops[i] = NewPopulatedCronJobList(popr, false)
	}
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		dAtA, err := github_com_gogo_protobuf_proto.Marshal(pops[i%10000])
...
func BenchmarkCronJobListProtoUnmarshal(b *testing.B) {
	popr := math_rand.New(math_rand.NewSource(616))
	total := 0
	datas := make([][]byte, 10000)
	for i := 0; i < 10000; i++ {
		dAtA, err := github_com_gogo_protobuf_proto.Marshal(NewPopulatedCronJobList(popr, false))
		if err != nil {
			panic(err)
		}
		datas[i] = dAtA
...
func BenchmarkCronJobSpecProtoMarshal(b *testing.B) {
	popr := math_rand.New(math_rand.NewSource(616))
	total := 0
	pops := make([]*CronJobSpec, 10000)
	for i := 0; i < 10000; i++ {
		pops[i] = NewPopulatedCronJobSpec(popr, false)
	}
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		dAtA, err := github_com_gogo_protobuf_proto.Marshal(pops[i%10000])
...
func BenchmarkCronJobSpecProtoUnmarshal(b *testing.B) {
	popr := math_rand.New(math_rand.NewSource(616))
	total := 0
	datas := make([][]byte, 10000)
	for i := 0; i < 10000; i++ {
		dAtA, err := github_com_gogo_protobuf_proto.Marshal(NewPopulatedCronJobSpec(popr, false))
		if err != nil {
			panic(err)
		}
		datas[i] = dAtA
...
func BenchmarkCronJobSize(b *testing.B) {
	popr := math_rand.New(math_rand.NewSource(616))
	total := 0
	pops := make([]*CronJob, 1000)
	for i := 0; i < 1000; i++ {
		pops[i] = NewPopulatedCronJob(popr, false)
	}
	b.ResetTimer()
...
func BenchmarkCronJobListSize(b *testing.B) {
	popr := math_rand.New(math_rand.NewSource(616))
	total := 0
	pops := make([]*CronJobList, 1000)
	for i := 0; i < 1000; i++ {
		pops[i] = NewPopulatedCronJobList(popr, false)
	}
	b.ResetTimer()
...
func BenchmarkCronJobSpecSize(b *testing.B) {
	popr := math_rand.New(math_rand.NewSource(616))
	total := 0
	pops := make([]*CronJobSpec, 1000)
	for i := 0; i < 1000; i++ {
		pops[i] = NewPopulatedCronJobSpec(popr, false)
	}
	b.ResetTimer()
