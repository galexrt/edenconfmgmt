...
import (
	...
	setdefaults_plugin "github.com/galexrt/edenconfmgmt/pkg/grpc/plugins/setdefaults"
...
func main() {
	...
	gen.GeneratePlugin(setdefaults_plugin.NewPlugin(useGogoImport))

	for i := 0; i < len(gen.Response.File); i++ {
		gen.Response.File[i].Name = proto.String(strings.Replace(*gen.Response.File[i].Name, ".pb.go", ".setdefaults.pb.go", -1))
	}
