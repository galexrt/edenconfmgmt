...
| Name        | Description                                                                              |
| ----------- | ---------------------------------------------------------------------------------------- |
| `macros`    | Macros (e.g., user defined template functions/shortcuts).                                |
| `variables` | Variables defined by user and/or target server.                                          |
| `event`     | Event info and data (only available when Job has been triggered through event reaction). |
| `server`    | Server info (of the current server).                                                     |
