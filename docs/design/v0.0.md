...
![v0.0/flow-init_and_failover.mmd rendered](v0.0/flow-init_and_failover.mmd.png)

See [v0.0/flow-init_and_failover.mmd](v0.0/flow-init_and_failover.mmd) for source code of diagram.

### Run

![v0.0/flow-run.mmd rendered](v0.0/flow-run.mmd.png)

See [v0.0/flow-run.mmd](v0.0/flow-run.mmd) for source code of diagram.
...
| ------------ | ---------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `eden`       | Object containing all edenrun functions and/or variables.                           | 1. To get the edenrun version running, 2. getting a list of servers by label.                                                                     |
